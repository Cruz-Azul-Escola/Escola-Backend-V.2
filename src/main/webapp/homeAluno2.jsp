...
<header class="topbar">
    ...
    <button onclick="history.back()" class="btn-logout">➜ Sair</button>
</header>
...
<%--                <%--%>
<%--                    String nomeProfessor = "Não informado";--%>

<%--                    if (--%>
<%--                            ta.getTurma().getProfessores() != null &&--%>
<%--                                    !ta.getTurma().getProfessores().isEmpty()--%>
<%--                    ) {--%>
<%--                        nomeProfessor = ta.getTurma().getProfessores().get(0).getNome();--%>
<%--                    }--%>
<%--                %>--%>
